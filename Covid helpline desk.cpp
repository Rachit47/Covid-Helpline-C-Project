...
class Covid_Testing
{ /*Acts as a common class for People, Zones, Hospital*/
...
public:
 ...
 Covid_Testing(string lname, string fname, string mname, int age, string contact_no, string
symptoms, string address, string gender)
 {
 this->lname = lname;
 this->fname = fname;
 this->mname = mname;
...
pann:
 ...
 if (pan.length() != 10)
 {
 cout << "\nPAN card number must be of 10 digits";
 goto pann;
 }
 cout << "\n----------------------------------------------";
...
void queue ::confirmList()
{
 ...
 while (temp != NULL)
 {
 cout << srNo << "\t" << temp->r << "\t\t" << temp->nm << "\t\t" << temp->age << "\t" <<
temp->aadhar << "\t" << temp->phn << "\t" << temp->pan;
 temp = temp->next;
 cout << "\n";
 srNo++;
 }
...
void People::registration(int family_member)
{
 ...
 cout << "Enter city: ";
 cin >> address_;
 new_person = new Covid_Testing(lname_, fname_, mname_, age_, contact_, symptoms_,
address_, gender_);
...
Covid_Testing *People::view_report(int PatientID)
{
 ...
 cout << "\n Patient Name:\t\t\t\t\t|" << temp1->lname << " " << temp1->fname << " " <<
temp1->mname;
 cout << "\n Age\t\t\t\t\t\t|" << temp1->age;
 cout << "\n Gender\t\t\t\t\t\t|" << temp1->gender;
 ...
 if (temp1->report_status == 0)
 cout << "\n\t\tYOU ARE TESTED " << temp1->Detection << " FOR SARS-CoV2COVID-19!";
 if (temp1->report_status == 2)
 cout << "\n\t\t\t\tYOUR REPORT STATUS IS " << temp1->Detection << " PLEASETRY AFTER SOME TIME";
...
void People::admin()
{
 ...
 {
 case 0:
 pending_status->report_status = 0;
 //pending_status->report_release_date = pending_status->date();
 break;
 case 1:
 pending_status->report_status = 1;
 //pending_status->report_release_date = pending_status->date();
 break;
 }
 }
...
void Hospital ::addHospital(string nm, string ct, int bed)
{ //, int patient){
...
cout << "\n COVID-19 TESTING PORTAL";
 ...
 {
 case 1:
 cout << "How many members you want to test for Covid-19: ";
 cin >> family_members;
 cout <<
"\n_____________________________________________________________________";
 ...
 h.admitPatient(ptr);
 break;
 case 'N': cout << "\nStay Home Quarantined. Wear mask. Take appropriateprecautions...";
 goto again;
 break;
 }
 }
...
vaccine:
 ...
 do
 {
 cout << "\n\n*******************MENU********************\n1.VACCINEREGISTRATION\t\t2.ABOUT VACCINE\n3.RULES FOR VACCINE\t\t4.Exit";
 cout << "\n\nEnter your choice:\n";
 cin >> ch;
 switch (ch)
 {
 ...
 cout << "\n\nWant to continue in delhi section ?\nif yes type y\nif not type n\n:";
 cin >> y;
 } while (y == 'y');
 break;
 case 2:
 ...
 cout << "\n\nWant to continue kolkata section ?\nif yes type y\nif not type n\n:";
 cin >> y;
 } while (y == 'y');
 break;
 case 4:
 ...
 cout << "\n\nWant to continue chennai section ?\nif yes type y\nif not type n\n:";
 cin >> y;
 } while (y == 'y');
 break;
 case 5:
 ...
 break;
 case 2:
 cout << "Vaccines definition\n\nThe body’s immune system helps protect against pathogens that cause infection. Most of the time, it’s an efficient system. It either keeps microorganisms out or tracks them down and gets rid of them.\nHowever, some pathogens can overwhelm the immune system. When this happens, it can cause serious illness.\nThe pathogens most likely to cause problems are the ones the body doesn’t recognize. Vaccination is a way to “teach” the immune system how to recognize and eliminate an organism. That way,your body is prepared if you’re ever exposed.\nVaccinations are an important form of primaryprevention. That means they can protect people from getting sick. \nVaccinations have allowedus to control diseases that once threatened many lives, such as:\n";
 cout << "\n\nmeasles\nolio\ntetanus\nwhooping cough\n"; cout << "\n\nIt’s important that as many people as possible get vaccinated. Vaccinationsdon’t just protect individuals. When enough people are vaccinated, it helps protect society.\nhisoccurs through herd immunity. Widespread vaccinations make it less likely that a susceptibleperson will come into contact with someone who has a particular disease.\n";
 cout << "\n\nHow does vaccination work?\nA healthy immune system defends againstinvaders. The immune system is composed of several types of cells. These cells defend againstand remove harmful pathogens. However, they have to recognize that an invader isdangerous.\nVaccination teaches the body to recognize new diseases. It stimulates the body tomake antibodies against antigens of pathogens. It also primes immune cells to remember thetypes of antigens that cause infection. That allows for a faster response to the disease in thefuture.\nVaccines work by exposing you to a safe version of a disease. \nThis can take the formof:";
 cout << "\n\na protein or sugar from the makeup of a pathogen\na dead or inactivatedform of a pathogen\na toxoid containing toxin made by a pathogen\na weakened pathogen";
 cout << "\n\nWhen the body responds to the vaccine, it builds an adaptive immuneresponse. This helps equip the body to fight off an actual infection.\nVaccines are usually givenby injection. Most vaccines contain two parts. The first is the antigen. This is the piece of thedisease your body must learn to recognize. The second is the adjuvant.\nThe adjuvant sends adanger signal to your body. It helps your immune system to respond more strongly against theantigen as an infection. This helps you develop immunity.";
 cout << "\n------------------------------------------------------------------------------------------------------------------------------------------";
 break;
 case 3:
 cout << "\n1.Documents Required:\n\nAadhar card OR PAN card\nPhone number\n";
 cout << "\n2.Person with confirmed or suspected COVID-19 infection may increase therisk of spreading the same to others at vaccination site. For this reason, infected individualsshould defer vaccination for 14 days after symptoms resolution.\n";
